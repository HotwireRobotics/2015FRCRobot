		...
		<Item Name="Sim Support Files" Type="Folder">
			<Item Name="FRC SimulatedRSC" Type="Folder">
				<Item Name="ive" Type="Folder">
					<Item Name="AXIS M1011.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/AXIS M1011.ive"/>
					<Item Name="Devantech SRF05.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/Devantech SRF05.ive"/>
					<Item Name="FRC - Body.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/FRC - Body.ive"/>
					<Item Name="Honeywell HMC6343.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/Honeywell HMC6343.ive"/>
					<Item Name="mecanum wheel frame.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel frame.ive"/>
					<Item Name="mecanum wheel frame0.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel frame0.ive"/>
					<Item Name="mecanum wheel frame01.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel frame01.ive"/>
					<Item Name="mecanum wheel frame012.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel frame012.ive"/>
					<Item Name="mecanum wheel roller.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel roller.ive"/>
					<Item Name="mecanum wheel roller0.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel roller0.ive"/>
					<Item Name="mecanum wheel roller01.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel roller01.ive"/>
					<Item Name="mecanum wheel roller012.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/mecanum wheel roller012.ive"/>
					<Item Name="Sparkfun Atomic IMU.ive" Type="Document" URL="../../Mecanum Prototype v5/Mecanum Prototype v1/FRC SimulatedRSC/ive/Sparkfun Atomic IMU.ive"/>
				</Item>
			</Item>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="navX Board Information.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Data TypeDefs/navX Board Information.ctl"/>
			<Item Name="navX Device Registers.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Value TypeDefs/navX Device Registers.ctl"/>
			<Item Name="navX Device TypeDef.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/navX Device TypeDef.ctl"/>
			<Item Name="navX Interface Protocol.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Value TypeDefs/navX Interface Protocol.ctl"/>
			<Item Name="navX NAVX_CAL_STATUS.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Value TypeDefs/navX NAVX_CAL_STATUS.ctl"/>
			<Item Name="navX NAVX_OP_STATUS.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Value TypeDefs/navX NAVX_OP_STATUS.ctl"/>
			<Item Name="navX NAVX_SENSOR_STATUS.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Value TypeDefs/navX NAVX_SENSOR_STATUS.ctl"/>
			<Item Name="navX Offsets Data.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Data TypeDefs/navX Offsets Data.ctl"/>
			<Item Name="navX Read.vi" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/IO/navX Read.vi"/>
			<Item Name="navX Status Data.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Data TypeDefs/navX Status Data.ctl"/>
			<Item Name="navX Update Rate.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Value TypeDefs/navX Update Rate.ctl"/>
			<Item Name="navX YPRH Data.ctl" Type="VI" URL="/navx-mxp_NEW/roborio/labview/navX-MXP Library/COMMON/TypeDefs/Data TypeDefs/navX YPRH Data.ctl"/>
			...
			<Item Name="WPI_SerialPortOpen_USB.vi" Type="VI" URL="/../navx-mxp_NEW/roborio/labview/navX-MXP Library/SERIAL/IO/NI WPI/WPI_SerialPortOpen_USB.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[0].itemID" Type="Str">{6008EBB4-5908-406A-BB73-9C182B20106C}</Property>
